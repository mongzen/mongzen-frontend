import { PageHeader, ServiceCard, WipeButton } from '@/components/ui';
import { DEFAULTS } from '@/constants';
import { getGlobalSettings, getServicePage } from '@/services/apiServer';
...
export default async function Service() {
  ...
  const resServiceData = await getServicePage();
  const serviceData = resServiceData?.data || null;

  const error = !globalData && !serviceData;
